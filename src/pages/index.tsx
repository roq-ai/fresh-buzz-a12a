...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`fresh buzz`}</title>

        <meta
          name="description"
          content="Experience Nature's Bounty with Fresh Buzz - Your Online Portal for Buying the Freshest and Healthiest Fruits Anytime, Anywhere."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517260739337-6799d239ce83?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVzaCUyMGZydWl0c3xlbnwwfHx8fDE2OTQ1NDI0NzN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience Nature's Bounty with Fresh Buzz - Your Online Portal for Buying the Freshest and Healthiest Fruits Anytime, Anywhere.`}
            </Text>
            <Box
